...
class Database:
    ...
    def fill_artist_table(self):
        ...
        self.cursor.execute('INSERT INTO artist(artist_name, is_active) VALUES ("Lorenzo", true);')
        self.cursor.execute('INSERT INTO artist(artist_name, is_active) VALUES ("Mattia", false);')
        self.cursor.execute('INSERT INTO artist(artist_name, is_active) VALUES ("Bastien", true);')
    ...
    def fill_album_table(self):
        ...
        self.cursor.execute('INSERT INTO album (artist_id, album_title, album_year) '
                            'VALUES ((select artist_id FROM artist WHERE artist_id '
                            '= 1), "Album de Lorenzo", "2022-10-21");')
        self.cursor.execute('INSERT INTO album (artist_id, album_title, album_year) '
                            'VALUES ((select artist_id FROM artist WHERE artist_id '
                            '= 2), "Album de Mattia", "2018-12-06");')
        self.cursor.execute('INSERT INTO album (artist_id, album_title, album_year) '
                            'VALUES ((select artist_id FROM artist WHERE artist_id '
                            '= 3), "Album de Bastien", "2021-01-13");')
    ...
    def get_albums(self, artist_id: str):
        ...
        :rtype: list[dict]
        """
        self.cursor.execute('SELECT * from album WHERE artist_id=%s', (artist_id,))
        return self.cursor.fetchall()
    ...
    def get_songs(self, album_id: str):
        ...
        :rtype: list[dict]
        """
        self.cursor.execute('SELECT * from song WHERE album_id=%s', (album_id,))
        return self.cursor.fetchall()
